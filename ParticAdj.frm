...
Begin VB.Form ParticAdj 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Partición extrajudicial"
   ClientHeight    =   6255
   ClientLeft      =   150
   ClientTop       =   435
   ClientWidth     =   3495
   Icon            =   "ParticAdj.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6255
...
ProtoLey.SelStart = 0
ProtoLey.SelLength = Len(goperativo)
End Sub
