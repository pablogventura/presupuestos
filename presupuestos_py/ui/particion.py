"""
Formulario Presupuesto - Partición o Adjudicación.
"""
...
from impresion import dibujar_particion


class ParticionWindow(BasePresupuestoWindow):
    TIPO_OPERACION = "Partición o Adjudicación"
