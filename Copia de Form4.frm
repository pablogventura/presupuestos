...
anotacion = "0,00"
Else
total = AgregaDecimales(CStr(CDbl(arAncel) + CDbl(certificado) + CDbl(aportes1) + CDbl(aportes2) + CDbl(anotacion) + CDbl(goperativo) + CDbl(otros1) + CDbl(otros2) + CDbl(otros3)))
...
certificado = AgregaDecimales(CStr(120))
aportes1 = AgregaDecimales(CStr(((CDbl(VEconomico) * 0.02 + 27.7) / 2) * 0.18))
aportes2 = AgregaDecimales(CStr(CDbl(VEconomico) * 0.003))
anotacion = AgregaDecimales(CStr(CDbl(0.002 * VEconomico) + 15))
goperativo = AgregaDecimales(CStr(270))
...
pWt = GenHTMLDonacion(GetSetting("Presupuestos", "Escribania", "Nombre", "Escribanía Ventura"), GetSetting("Presupuestos", "Escribania", "Direccion", "Bv. San Juan 380 - P.B." & Chr(34) & "A" & Chr(34)), GetSetting("Presupuestos", "Escribania", "Telefonoemail", "Te: 4255715 - e-mail: gabventura@arnet.com.ar"), Donacion.partes, Donacion.VEconomico, Donacion.arAncel, Donacion.certificado, Donacion.aportes1, Donacion.aportes2, Donacion.anotacion, Donacion.goperativo, Donacion.total, Donacion.notros1, Donacion.otros1, Donacion.notros2, Donacion.otros2, Donacion.notros3, Donacion.otros3)
...
Dim res As String
If MsgBox("¿Desea cerrar esta ventana y perder los datos?", vbInformation + vbYesNo, App.Title) = vbNo Then
Cancel = 1
End If
End Sub
...
Clipboard.SetText GenHTMLDonacion(GetSetting("Presupuestos", "Escribania", "Nombre", "Escribanía Ventura"), GetSetting("Presupuestos", "Escribania", "Direccion", "Bv. San Juan 380 - P.B." & Chr(34) & "A" & Chr(34)), GetSetting("Presupuestos", "Escribania", "Telefonoemail", "Te: 4255715 - e-mail: gabventura@arnet.com.ar"), partes, VEconomico, arAncel, certificado, aportes1, aportes2, anotacion, goperativo, total, notros1, otros1, notros2, otros2, notros3, otros3)
End Sub
